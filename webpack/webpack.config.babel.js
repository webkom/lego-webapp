...
module.exports = {
  ...
  plugins: compact([
    ...
    new webpack.DefinePlugin({
      ...
      'process.env.API_URL': JSON.stringify(process.env.API_URL) || 'http://127.0.0.1:8000/api/v1',
      'process.env.WS_URL': JSON.stringify(process.env.WS_URL) || 'http://127.0.0.1:8000',
