...
const config = {
  serverUrl: import.meta.env.VITE_API_URL || 'http://127.0.0.1:8000/api/v1',
  wsServerUrl: import.meta.env.VITE_WS_URL || 'ws://127.0.0.1:8000',
...
export const configWithSSR = {
  ...config,
  serverUrl: import.meta.env.SSR_API_URL || config.serverUrl,
  baseUrl: import.meta.env.SSR_BASE_URL || config.baseUrl,
} as Config;
