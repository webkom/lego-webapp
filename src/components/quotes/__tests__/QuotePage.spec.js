...
describe('components', () => {
  describe('QuotePage', () => {
    it('should show sort icons if page is a list of approved/unapproved quotes', () => {
      const wrapper = shallow(<QuoteTopNav {...props} quotes={props.quotes} />);
    ...
    it('should only display one quote if route is a single quote', () => {
      ...
      props.quotes.pop();
      const wrapper = shallow(<QuoteList {...props} quotes={props.quotes} />);
    ...
    it('should notice that like is clicked and recieve correct quoteId', () => {
      ...
      const wrapper = shallow(<SingleQuote like={like} {...props} quote={props.quotes[0]} />);
      wrapper.find('.likes').simulate('click');
