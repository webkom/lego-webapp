...
import styles from '~/pages/(migrated)/events/index/EventList.module.css';
import joblistingListStyles from '~/pages/(migrated)/joblistings/_components/JoblistingList.module.css';
