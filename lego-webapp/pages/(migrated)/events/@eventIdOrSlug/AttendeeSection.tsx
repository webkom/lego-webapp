...
import { getWaitingListPosition } from '~/pages/(migrated)/events/@eventIdOrSlug/getWaitingListPosition';
import { getEventSemesterFromStartTime } from '~/pages/(migrated)/events/utils';
