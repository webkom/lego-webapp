...
import SemesterStatus from '~/pages/(migrated)/bdb/SemesterStatus';
import {
  semesterToHumanReadable,
  groupStudentContactsBySemester,
} from '~/pages/(migrated)/bdb/utils';
...
import type { GroupedStudentContactsBySemester } from '~/pages/(migrated)/bdb/utils';
