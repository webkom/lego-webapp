...
const BdbPage = () => {
  ...
  const semesterStats = useMemo(() => {
    ...
    const totalEvents = recentCompanies.reduce(
  ...
  const columns: ColumnProps<CompanyWithStats>[] = [
    ...
    {
      title: 'Sist presentasjon',
      dataIndex: 'lastPresentationDate',
    ...
    },
    {
      ...
      centered: true,
      render: (rating) => <Flex>{rating}</Flex>,
    },
    {
      title: 'Frafall',
      dataIndex: 'noShow',
      centered: true,
      render: (noShow) => <Flex>{noShow}</Flex>,
    },
  ];
