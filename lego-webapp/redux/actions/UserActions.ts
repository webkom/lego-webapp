...
import type { FormValues as ChangePasswordFormValues } from '~/pages/(migrated)/users/_components/ChangePassword';
import type { FormValues as UserConfirmationFormValues } from '~/pages/(migrated)/users/registration/+Page';
