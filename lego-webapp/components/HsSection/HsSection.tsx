        ...
        <Flex column gap="var(--spacing-xs)">
          ...
          >
            ...
            <div className={styles.textWrapper}>
              ...
              <span className={`secondaryFontColor ${styles.subtext}`}>Dokumentasjon, rutiner og nyttig info</span>
            </div>
          </a>
          <a
          ...
          >
            ...
            <div className={styles.textWrapper}>
              ...
              <span className={`secondaryFontColor ${styles.subtext}`}> Møtereferater fra HS-møter</span>
            </div>
          </a>
          <a
          ...
          >
            ...
            <div className={styles.textWrapper}>
              ...
              <span className={`secondaryFontColor ${styles.subtext}`}>Send inn et anonymt varsel</span>
            </div>
          </a>
        </Flex>
      </div>
