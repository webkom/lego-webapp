...
class ImageUploadField extends Component<Props> {
  ...
  render() {
    ...
    return <div className={cx(styles.base, styles.coverImage, className && className)} style={style} name={name}>
        <ImageUpload className={styles.textField} onSubmit={this.onSubmit} showErrors={false} {...(props as Record<string, any>)} />
      </div>;
  }
