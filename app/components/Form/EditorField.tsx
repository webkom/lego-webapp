...
const EditorField = ({
  ...
  return <div name={name}>
      {initialized && <Editor className={cx(styles.input, className)} {...props} {...props.input} {...props.meta} imageUpload={imageUpload} />}
    </div>;
};

EditorField.AutoInitialized = props => EditorField({
