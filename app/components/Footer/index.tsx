...
const Footer = ({
  loggedIn
}: Props) => <footer className={styles.footer}>
    <div className={styles.footerContent}>
      <div className={cx(styles.section, utilityStyles.hiddenOnMobile)}>
        <a href="https://github.com/webkom" rel="noopener noreferrer" target="_blank" className={styles.gitHubLink}>
        ...
        <div className={styles.legoLinks}>
          <a href="https://github.com/webkom/lego-webapp" rel="noopener noreferrer" target="_blank">
            FRONTEND
          </a>
          <b>|</b>
          <a href="https://github.com/webkom/lego" rel="noopener noreferrer" target="_blank">
            BACKEND
          </a>
        </div>
      </div>
    ...
    <div className={styles.bottom}>
      <div className={styles.bottomContent}>
        <Image className={styles.cooperator} src={netcompany} alt="netcompany" />
