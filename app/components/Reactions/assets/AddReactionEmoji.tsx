...
const AddReactionEmoji = ({
  color
    ...
    <span>
      <svg aria-hidden="true" focusable="false" width="0.44em" height="1em" preserveAspectRatio="xMidYMid meet" className={styles.emoji} viewBox="0 0 7 16">
        <path fillRule="evenodd" d="M4 4H3v3H0v1h3v3h1V8h3V7H4V4z" fill={color} />
      </svg>
    </span>
    <span className={styles.smiley}>
      <svg aria-hidden="true" focusable="false" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" className={styles.emoji} viewBox="0 0 16 16">
