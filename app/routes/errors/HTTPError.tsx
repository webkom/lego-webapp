...
const getHTTPError = statusCode => HTTPMapping[statusCode] || HTTPMapping[fallbackStatus];
...
export default class HTTPError extends Component<Props> {
  ...
  render() {
    ...
    return <Container>
        <Flex column alignItems="center" justifyContent="center" style={{
        padding: '10px'
      }}>
          <Link to="/">
