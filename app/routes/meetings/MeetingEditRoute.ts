...
import { editMeeting, fetchMeeting, inviteUsersAndGroups, deleteMeeting } from "app/actions/MeetingActions";
...
}, dispatch) => dispatch(fetchMeeting(meetingId))), connect(mapStateToProps, mapDispatchToProps))(MeetingEditor);