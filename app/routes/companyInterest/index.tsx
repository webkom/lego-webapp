  ...
  match: {
    ...
    loggedIn
      ...
      loggedIn
        ...
        <RouteWrapper exact path={`${match.path}/create`} passedProps={{
      currentUser,
      loggedIn
    }} Component={CompanyInterestRoute} />
        <RouteWrapper exact path={`${match.path}/semesters`} passedProps={{
      currentUser,
      loggedIn
    }} Component={CompanySemesterGUIRoute} />
        <RouteWrapper exact path={`${match.path}/:companyInterestId/edit`} passedProps={{
      currentUser,
      loggedIn
