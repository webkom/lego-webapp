...
const PollsList = ({
  ...
  fetching
    ...
    <Paginator infiniteScroll={true} hasMore={hasMore} fetching={fetching} fetchNext={() => {
    fetchAll({
      next: true
    });
  }}>
      <section className={styles.pollsList}>
        {polls.map(poll => <Link key={poll.id} to={`/polls/${poll.id}`} className={styles.pollItem}>
              ...
              <Flex wrap justifyContent="space-between">
                ...
                <Flex alignItems="center" gap={2}>
                  ...
                  color: 'var(--color-green-4)'
                      ...
                      Ikke svart
                      <Icon name="close-circle-outline" size={20} style={{
