...
import { fetch, deletePicture, updatePicture } from "app/actions/GalleryPictureActions";
import { fetchGallery, deleteGallery, updateGallery, updateGalleryCover } from "app/actions/GalleryActions";
...
}, dispatch) => Promise.all([dispatch(fetch(params.galleryId)), dispatch(fetchGallery(params.galleryId))])), loadingIndicator(['gallery.title']))(GalleryEditor);