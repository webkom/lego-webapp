  ...
  match: {
    ...
    loggedIn
      ...
      loggedIn
        ...
        <RouteWrapper exact path={`${match.path}/:galleryId`} passedProps={{
      currentUser,
      loggedIn
    }} Component={GalleryDetailRoute} />
        <RouteWrapper exact path={`${match.path}/:galleryId/edit`} passedProps={{
      currentUser,
      loggedIn
    }} Component={GalleryEditRoute} />
        <RouteWrapper exact path={`${match.path}/:galleryId/picture/:pictureId`} passedProps={{
      currentUser,
      loggedIn
    }} Component={GalleryPictureRoute} />
        <RouteWrapper exact path={`${match.path}/:galleryId/picture/:pictureId/edit`} passedProps={{
      currentUser,
      loggedIn
