...
class SurveyDetail extends Component<Props> {
  ...
  render() {
    ...
    return <Content className={styles.surveyDetail} banner={!survey.templateType && survey.event.cover}>
        ...
        <ContentSection>
          ...
          <AdminSideBar surveyId={survey.id} actionGrant={actionGrant} token={survey.token} shareSurvey={shareSurvey} hideSurvey={hideSurvey} />
        </ContentSection>
      </Content>;
  }
