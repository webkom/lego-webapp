  ...
  match: {
    ...
    loggedIn
      ...
      loggedIn
        ...
        <RouteWrapper exact path={`${match.path}/add`} passedProps={{
      currentUser,
      loggedIn
    }} Component={AddSurveyRoute} />
        <RouteWrapper exact path={`${match.path}/templates`} passedProps={{
      currentUser,
      loggedIn
    }} Component={TemplatesRoute} />
        <RouteWrapper exact path={`${match.path}/:surveyId`} passedProps={{
      currentUser,
      loggedIn
    }} Component={SurveyDetailRoute} />
        <RouteWrapper exact path={`${match.path}/:surveyId/edit`} passedProps={{
      currentUser,
      loggedIn
    }} Component={EditSurveyRoute} />
        <RouteWrapper exact path={`${match.path}/:surveyId/answer`} passedProps={{
      currentUser,
      loggedIn
        ...
        location
              ...
              <RouteWrapper exact path={`${match.path}/summary`} passedProps={{
          currentUser,
          loggedIn
        }} Component={SubmissionSummary} />
              <RouteWrapper exact path={`${match.path}/individual`} passedProps={{
          currentUser,
          loggedIn
        }} Component={SubmissionIndividual} />
            </SubmissionsRoute>}
        </Route>
        <Route exact path={`${match.path}/:surveyId/results`} component={SubmissionsPublicResultsRoute} />
