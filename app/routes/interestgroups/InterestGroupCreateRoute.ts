...
const mapDispatchToProps = {
  ...
  joinGroup,
  uploadFile,
  handleSubmitCallback: group => createGroup({ ...group,
    type: 'interesse'
  })
};
...
export default compose(replaceUnlessLoggedIn(LoginPage), connect(mapStateToProps, mapDispatchToProps))(InterestGroupCreate);