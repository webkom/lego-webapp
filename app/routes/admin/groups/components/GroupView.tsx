...
const Group = (props: GroupProps) => {
  ...
  return <div>
      ...
      <Switch>
        <RouteWrapper path={`${match.path}/settings`} Component={GroupSettings} passedProps={{
        group
      }} />
        <Route path={`${match.path}/members`} component={ConnectedGroupMembers} />
        <RouteWrapper path={`${match.path}/permissions`} Component={ConnectedGroupPermissions} passedProps={{
        group
      }} />
      </Switch>
    </div>;
