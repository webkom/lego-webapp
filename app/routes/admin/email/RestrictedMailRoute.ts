...
}, dispatch) => dispatch(fetchRestrictedMail(params.restrictedMailId));

export default compose(prepare(loadData, ['match.params.restrictedMailId']), connect(mapStateToProps, {}), loadingIndicator(['restrictedMail.id']))(RestrictedMailEditor);