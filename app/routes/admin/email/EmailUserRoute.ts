...
}, dispatch) => dispatch(fetchEmailUser(params.emailUserId));

export default compose(prepare(loadData, ['match.params.emailUserId']), connect(mapStateToProps, mapDispatchToProps), loadingIndicator(['emailUser.user.id']))(EmailUserEditor);