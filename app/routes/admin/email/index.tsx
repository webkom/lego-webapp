        ...
        <Route path={`${match.path}`}>
          <EmailRoute>
            <Switch>
              ...
              <Route exact path={`${match.path}/lists/new`} component={CreateEmailListRoute} />
              <Route exact path={`${match.path}/lists/:emailListId`} component={EmailListRoute} />
              <Route exact path={`${match.path}/users`} component={EmailUsersRoute} />
              <Route exact path={`${match.path}/users/new`} component={CreateEmailUserRoute} />
              <Route exact path={`${match.path}/users/:emailUserId`} component={EmailUserRoute} />
              <Route exact path={`${match.path}/restricted`} component={RestrictedMailsRoute} />
              <Route exact path={`${match.path}/restricted/new`} component={CreateRestrictedMailRoute} />
              <Route exact path={`${match.path}/restricted/:restrictedMailId`} component={RestrictedMailRoute} />
