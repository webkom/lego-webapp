...
const UpdateAllergies = ({
  ...
  marginBottom: '20px'
    ...
    <div className={styles.update}>
      <Field id="allergies" name="allergies" placeholder="Ingen" fieldClassName={styles.allergies} component={TextInput.Field} />
      <Button success className={styles.button} submit disabled={invalid || pristine || submitting}>
        Oppdater
      </Button>
    </div>
  </Form>;
