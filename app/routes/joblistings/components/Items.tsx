...
export const Year = ({
  joblisting
    ...
    {joblisting.fromYear === joblisting.toYear ? `${joblisting.fromYear}. ` : `${joblisting.fromYear}. - ${joblisting.toYear}. `}
    klasse
  </span>;
...
export const Workplaces = ({
  places
}: WorkplacesProps) => <span>{joinValues(places.map(place => place.town))}</span>;
const types = {
  full_time: 'Fulltid',
  part_time: 'Deltid',
