...
const jobListingRoute = ({
  ...
  match: {
    ...
    loggedIn
        ...
        <RouteWrapper path={`${match.path}/create`} passedProps={{
      currentUser,
      loggedIn
    }} Component={JoblistingCreateRoute} />
        <Route exact path={`${match.path}/:joblistingId`} component={JoblistingDetailedRoute} />
        <RouteWrapper path={`${match.path}/:joblistingId/edit`} passedProps={{
      currentUser,
      loggedIn
