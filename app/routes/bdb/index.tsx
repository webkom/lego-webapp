  ...
  match: {
    ...
    loggedIn
      ...
      loggedIn
        ...
        <RouteWrapper exact path={`${match.path}/:companyId`} passedProps={{
      currentUser,
      loggedIn
    }} Component={BdbDetailRoute} />
        <RouteWrapper exact path={`${match.path}/:companyId/edit`} passedProps={{
      currentUser,
      loggedIn
    }} Component={EditCompanyRoute} />
        <RouteWrapper exact path={`${match.path}/:companyId/semesters/add`} passedProps={{
      loggedIn
    }} Component={AddSemesterRoute} />
        <RouteWrapper exact path={`${match.path}/:companyId/company-contacts/add`} passedProps={{
      currentUser,
      loggedIn
    }} Component={AddCompanyContactRoute} />
        <RouteWrapper exact path={`${match.path}/:companyId/company-contacts/:companyContactId`} passedProps={{
      currentUser,
      loggedIn
