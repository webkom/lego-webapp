...
import { editCompany, fetchAdmin, deleteCompany } from "../../actions/CompanyActions";
...
}, dispatch) => dispatch(fetchAdmin(companyId)), ['match.params.companyId']), connect(mapStateToProps, mapDispatchToProps))(CompanyEditor);