...
import { fetchAdmin, editCompanyContact, deleteCompany } from "../../actions/CompanyActions";
import CompanyContactEditor from "./components/CompanyContactEditor";
import { selectCompanyById, selectCompanyContactById } from "app/reducers/companies";
...
}, dispatch) => dispatch(fetchAdmin(companyId)), ['match.params.companyId', 'match.params.companyContactId']), connect(mapStateToProps, mapDispatchToProps))(CompanyContactEditor);