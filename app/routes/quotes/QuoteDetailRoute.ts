...
}, dispatch) => dispatch(fetchQuote(params.quoteId), fetchEmojis());
...
export default compose(replaceUnlessLoggedIn(LoginPage), prepare(loadData, ['match.params.quoteId']), connect(mapStateToProps, mapDispatchToProps))(QuotePage);