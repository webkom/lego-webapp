...
const usersRoute = ({
  ...
  match: {
    ...
    loggedIn
        ...
        <RouteWrapper exact path={`${match.path}/registration`} passedProps={{
      currentUser,
      loggedIn
    }} Component={UserConfirmationRoute} />
        <RouteWrapper exact path={`${match.path}/reset-password`} passedProps={{
      currentUser,
      loggedIn
    }} Component={UserResetPasswordRoute} />
        <RouteWrapper exact path={`${match.path}/:username`} passedProps={{
      currentUser,
      loggedIn
        ...
        location
              ...
              <RouteWrapper exact path={`${match.path}/profile`} passedProps={{
          currentUser,
          loggedIn
        }} Component={UserSettingsRoute} />
              <RouteWrapper exact path={`${match.path}/notifications`} passedProps={{
          currentUser,
          loggedIn
        }} Component={UserSettingsNotificationsRoute} />
              <RouteWrapper exact path={`${match.path}/oauth2`} passedProps={{
          currentUser,
          loggedIn
        }} Component={UserSettingsOAuth2Route} />
              <RouteWrapper exact path={`${match.path}/oauth2/new`} passedProps={{
          currentUser,
          loggedIn
        }} Component={UserSettingsOAuth2CreateRoute} />
              <RouteWrapper exact path={`${match.path}/oauth2/:applicationId(\\d+)`} passedProps={{
          currentUser,
          loggedIn
        }} Component={UserSettingsOAuth2EditRoute} />
              <RouteWrapper exact path={`${match.path}/student-confirmation`} passedProps={{
          currentUser,
          loggedIn
