...
import { fetchOAuth2Applications, fetchOAuth2Grants, deleteOAuth2Grant } from "app/actions/OAuth2Actions";
...
export default compose(prepare(loadData), connect(mapStateToProps, mapDispatchToProps))(UserSettingsOAuth2);