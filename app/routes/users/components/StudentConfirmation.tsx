...
import { Form, TextInput, RadioButton, RadioButtonGroup, Button, Captcha } from "app/components/Form";
      ...
      <div>
        ...
        <Form onSubmit={handleSubmit(handleSendConfirmation)}>
          <Tooltip content="Brukernavnet du logger inn på NTNU med. Dette er delen som er foran @stud.ntnu.no. OBS: Ikke skriv inn hele eposten">
            <Field name="studentUsername" placeholder="NTNU Brukernavn" label="NTNU Brukernavn" component={TextInput.Field} />
          </Tooltip>
          <RadioButtonGroup name="course" label="Hvilken linje tilhører du?">
            <Field name="studentCompScience" label="Datateknologi" component={RadioButton.Field} inputValue="data" />
            <Field name="studentCommunicationTechnology" label="Kommunikasjonsteknologi" component={RadioButton.Field} inputValue="komtek" />
          </RadioButtonGroup>
          <RadioButtonGroup name="isTwoYears" label={<Flex>
            ...
            <Field name="isTwoYearsYes" label="2-årig master" component={RadioButton.Field} inputValue="true" />
            <Field name="isTwoYearsNo" label="5-årig master" component={RadioButton.Field} inputValue="false" />
          </RadioButtonGroup>
          <RadioButtonGroup name="member" label="Vil du bli medlem i Abakus?">
            <Flex>
              ...
              marginLeft: '5px'
                ...
                <p className={styles.infoText}>
                  ...
                  om{' '}
                  <a href="https://abakus.no/pages/info-om-abakus" rel="noopener noreferrer" target="_blank">
                    Abakus
                  </a>{' '}
                  og{' '}
                  <a href="https://statutter.abakus.no#medlemskap" rel="noopener noreferrer" target="_blank">
                    medlemskapet.
                  </a>
            ...
            <Field name="studentIsMemberYes" label="Ja" component={RadioButton.Field} inputValue="true" />
            <Field name="studentIsMemberNo" label="Nei" component={RadioButton.Field} inputValue="false" />
          </RadioButtonGroup>
