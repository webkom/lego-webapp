  ...
  return <Content>
      ...
      <NavigationTab title="Innstillinger">
        {props.isMe && <>
            ...
            {!props.currentUser.isStudent && <NavigationLink to={`${base}/student-confirmation`}>
                Verifiser studentstatus
              </NavigationLink>}
          </>}
      </NavigationTab>
      {props.children && props.children.map(child => cloneElement(child, { ...omit(props, 'match'),
      children: undefined
    }))}
    </Content>;
};
...
export default compose(replaceUnlessLoggedIn(LoginPage), // $FlowFixMe
connect(mapStateToProps))(UserSettingsIndex);