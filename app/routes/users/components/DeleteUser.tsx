...
const DeleteUser = ({
  ...
  return <>
      {!show && <Button danger onClick={() => setShow(true)}>
      ...
      {show && <>
          ...
          <Form onSubmit={handleSubmit}>
            <Field label="Nåværende passord" name="password" type="password" autocomplete="current-password" component={TextInput.Field} />
...
export default legoForm({
  ...
  onSubmit: (data, dispatch, {
    deleteUser,
    push
  }: Props) => deleteUser(data.password).then(() => push('/'))
})(DeleteUser);