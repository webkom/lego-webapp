...
import { fetchAll, fetchPage, updatePage, deletePage } from "app/actions/PageActions";
...
}, dispatch) => dispatch(fetchPage(pageSlug)), ['match.params.pageSlug']), connect(mapStateToProps, mapDispatchToProps), legoForm({
  form: 'page-edit'
}))(PageEditor);