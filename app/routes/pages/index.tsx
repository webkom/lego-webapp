  ...
  match: {
    ...
    loggedIn
      ...
      loggedIn
        ...
        <RouteWrapper exact path={`${match.path}/:section`} passedProps={{
      currentUser,
      loggedIn
    }} Component={PageDetailRoute} />
        <RouteWrapper exact path={`${match.path}/:section/:pageSlug`} passedProps={{
      currentUser,
      loggedIn
    }} Component={PageDetailRoute} />
        <RouteWrapper exact path={`${match.path}/:section/:pageSlug/edit`} passedProps={{
      currentUser,
      loggedIn
