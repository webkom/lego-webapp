...
export function createCompanyInterest(data: CompanyInterestEntity, isEnglish: boolean): Thunk<any> {
  return dispatch => {
    return dispatch(callAPI({
      ...
      message: isEnglish ? 'Submission successful!' : 'Bedriftsinteresse opprettet!'
    })));
  };
}
...
export function updateCompanyInterest(id: number, data: CompanyInterestEntity): Thunk<any> {
  return dispatch => {
    return dispatch(callAPI({
