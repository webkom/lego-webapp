...
export const Event = {
  ...
  SOCKET_INITIATE_PAYMENT: (generateStatuses('Event.SOCKET_INITIATE_PAYMENT') as AAT),
...
export const Meeting = {
  ...
  SET_INVITATION_STATUS: (generateStatuses('Meeting.SET_INVITATION_STATUS') as AAT),
  ...
  ANSWER_INVITATION_TOKEN: (generateStatuses('Meeting.ANSWER_INVITATION_TOKEN') as AAT),
...
export const Company = {
  ...
  FETCH_COMPANY_CONTACT: (generateStatuses('Company.FETCH_COMPANY_CONTACT') as AAT),
  ...
  DELETE_SEMESTER_STATUS: (generateStatuses('Company.DELETE_SEMESTER_STATUS') as AAT),
  ...
  DELETE_COMPANY_CONTACT: (generateStatuses('Company.DELETE_COMPANY_CONTACT') as AAT),
...
export const User = {
  ...
  SEND_REGISTRATION_TOKEN: (generateStatuses('User.SEND_REGISTRATION_TOKEN') as AAT),
  VALIDATE_REGISTRATION_TOKEN: (generateStatuses('User.VALIDATE_REGISTRATION_TOKEN') as AAT),
  CREATE_USER: (generateStatuses('User.CREATE_USER') as AAT),
  SEND_STUDENT_CONFIRMATION_TOKEN: (generateStatuses('User.SEND_STUDENT_CONFIRMATION_TOKEN') as AAT),
  CONFIRM_STUDENT_USER: (generateStatuses('User.CONFIRM_STUDENT_USER') as AAT),
  SEND_FORGOT_PASSWORD_REQUEST: (generateStatuses('User.SEND_FORGOT_PASSWORD_REQUEST') as AAT),
...
export const NotificationSettings = {
  FETCH_ALTERNATIVES: (generateStatuses('NotificationSettings.FETCH_ALTERNATIVES') as AAT),
